<?php 
	...
	{
		$gps_var_date = $gps_var_longitude = $gps_var_latitude = $gps_var_time = "GPS NON DETECTE";
	}
	else
	{
						...
						<form method="GET" action="home.php" id="formAjax1">
							...
							<div id="c_db_filter">
								<div id="c_db_filter_search">
									<div class="ic3">
										<input class="input" type="text" placeholder="Rechercher..." value="" />
									</div>
							...
							<div id="c_db_scroll">
								...
								<div class="box">
									<select name="db_select3" id="db_select3" onchange="maskSomeItems()">
